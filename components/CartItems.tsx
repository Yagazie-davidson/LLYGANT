      ...
      <Table>
        <TableHeader>
          <TableRow className="bg-none">
            ...
            <TableHead className="text-[10px] font-normal tracking-[1.3px] max-[606px]:hidden block">
              QUANTITY
            </TableHead>
              ...
              >
                <TableCell className="font-medium md:pr-14">
                  <div className="flex items-center md:space-x-10">
                    ...
                    <div className="hidden md:block max-[606px]:block">
                  ...
                  <div className="max-[606px]:flex hidden items-center space-x-5">
                ...
                <TableCell className="max-[606px]:hidden block w-full">
